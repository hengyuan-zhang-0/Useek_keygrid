...
arg_parser.add_argument('--segment_dataset', type=str, default='/home/henry/robot/end2end/USEEK/data/saved_segments/pants_expand.npz')
arg_parser.add_argument('--checkpoint', type=str, default='./data/saved_models/pants_useek.pt',
...
arg_parser.add_argument('-k', '--n-keypoints', type=int, default=8,  #original default 5 
